...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static TArray<UTexture2D*> GetSubstanceTextures(USubstanceGraphInstance* GraphInstance);
    ...
    UFUNCTION(BlueprintCallable)
    static TArray<UMaterial*> GetSubstanceIncludedMaterials();
    ...
    UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject"))
    static USubstanceGraphInstance* CreateGraphInstance(UObject* WorldContextObject, USubstanceInstanceFactory* Factory, int32 GraphDescIndex, UMaterial* ParentMaterial, const FString& InstanceName);
